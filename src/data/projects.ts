...
export const STATIC_PROJECTS: Project[] = [
  {
    ...
    github_url: 'https://github.com/GSR07/frankapanda-simulation',
    blog_url: '/franka-pick-and-place-blog.html',
    concepts: ['moveit2', 'tf2', 'hsv-segmentation', 'ros2-nodes-topics-services'],
    specs: [
      { label: 'STACK', value: 'ROS 2 Humble + MoveIt2' },
      { label: 'SIM', value: 'Ignition Gazebo (Fortress)' },
      { label: 'GRASP RATE', value: '80–85%' },
  ...
  },
  {
    ...
    concepts: ['nav2', 'slam', 'amcl', 'ros2-control', 'q-learning', 'behavior-trees', 'occupancy-grid'],
    specs: [
      { label: 'DRIVE', value: 'Differential, ros2_control' },
      { label: 'NAV', value: 'Nav2 + AMCL + SLAM Toolbox' },
      { label: 'SENSOR', value: 'RPLIDAR A1' },
      { label: 'STATUS', value: '● Sim → real hardware' },
    ],
    created_at: '',
    updated_at: '',
  },
  {
    ...
    concepts: ['dh-kinematics', 'moveit2'],
    created_at: '',
    updated_at: '',
  },
  {
    ...
    concepts: ['slam', 'nav2', 'amcl', 'path-planning'],
    created_at: '',
    updated_at: '',
  },
  {
    ...
    concepts: ['ros2-nodes-topics-services', 'p-controller'],
    created_at: '',
    updated_at: '',
  },
  {
  ...
  },
  {
    ...
    concepts: ['cnn-transfer-learning'],
    created_at: '',
    updated_at: '',
  },
  {
    ...
    visual_class: 'pv-iot',
    blog_url: '/ble.html',
    concepts: ['ble-rssi-trilateration', 'mqtt'],
    created_at: '',
    updated_at: '',
  },
  {
